...
namespace rt
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"An error occurred while creating or cleaning the directory: {ex.Message}");
                return; // Stop execution if we can't create or clean the directory
            }
